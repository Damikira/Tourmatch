...
const Registro = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    rol: 'TURISTA' // Solo necesitamos nombre, email, clave y rol
  });
  ...
  const handleSubmit = async (e) => {
    ...
    // Enviamos solo los datos del USUARIO
    const resultado = await register(
      formData.nombre,
      formData.email,
      formData.password,
      formData.rol // Se envía TURISTA o CONDUCTOR
    );
    ...
    <div className={styles.container}>
      <div className={styles.registerCard}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {/* HEMOS ELIMINADO LOS CAMPOS DE PATENTE Y CAPACIDAD DE AQUÍ */}
